...
<div class="gestion-header"><div><span class="learning-admin-kicker">Competencias</span><h1>Skills</h1><p class="dashboard-subtitle">Define las competencias tecnológicas que podrán relacionarse con los cursos.</p></div><div class="skill-header-actions"><a href="reporte.php" class="btn-secundario">📊 Reporte trabajadores</a><a href="crear.php" class="btn-crear">+ Nueva skill</a></div></div>
